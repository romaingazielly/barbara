...
<html lang="fr">
    ...
    <body class="page-projet">
      ...
      <section class="container projets classic-expert">
        ...
        <aside>
          <a class="projet-nav" id="projet-prev" href="/projets/auzou" title="Voir le projet Auzou">
            <span>Previous project</span>
            <span class="projet-name">Auzou</span>
          </a>
          <a id="projet-top" href="" title="Go to Top">Top</a>
          <a class="projet-nav" id="projet-next" href="/projets/balle-au-bond" title="Voir le projet La Balle au bond">
